...
class AlarmNotifications(models.Model):
    ...
    aisle_group = models.ForeignKey('AisleGroup', on_delete=models.CASCADE, null=True, blank=True)
    alarm_type = ((0, "Low_balance"), (1, "Power_Cut"), (2, "Pending Balance"), (3, "Pending Request"),
                  (4, "Zero balance"), (5, "Box opened"), (6, "Internet_Gone"), (7, "High Consumption"), (8, "Low Consumption"), (9, "No DG Run"))
    Alarm_type = models.PositiveIntegerField(choices=alarm_type)
    create_DateTime = models.DateTimeField(auto_now=False, auto_now_add=True)
    alarm_priorities = ((0, 'Normal'), (1, 'High'))
    Alarm_priority = models.PositiveIntegerField(choices=alarm_priorities, default=0)
...
class SiteCeleryPing(models.Model):
    site = models.ForeignKey(Site, on_delete=models.CASCADE, null=True, blank=True)
    home_gateway_id = models.CharField(max_length=200, blank=True, null=True)
    leg_id = models.CharField(max_length=100, blank=True, null=True, verbose_name="Leg ID")
    aisle_group = models.CharField(max_length=100, blank=True, null=True, verbose_name="Aisle Group")
...
class RecoveryMonitor(models.Model):
    ...
    aisle_group = models.ForeignKey(AisleGroup, on_delete=models.SET_NULL, blank=True, null=True)
    ...
    class Meta:
        indexes = [
            models.Index(fields=["site", "recovery_type", "status"], name="idx_recovery_site_status"),
            models.Index(fields=["site", "leg_id", "recovery_type"], name="idx_recovery_site_leg"),
            models.Index(fields=["site", "power_source", "recovery_type"], name="idx_recovery_site_source"),
            models.Index(fields=["requested_at", "is_active"], name="idx_recovery_active_time"),
        ]
