...
def roadcasteAPI(start_time, end_time):
    start_dt_object , end_dt_object = datetime.fromtimestamp(start_time) , datetime.fromtimestamp(end_time)
    start_time , end_time = start_dt_object.strftime('%Y-%m-%dT%H:%M:%S.%f')[:-3] + 'Z' , end_dt_object.strftime('%Y-%m-%dT%H:%M:%S.%f')[:-3] + 'Z'
...
def DG_fuel_for_Roadcaste(site_id, aisle_group, new_unit_consumption, entry_time):
    ...
    if dg_unit.exists():
        ...
        if(check_dg_status and aisle_group[0].power_source not in [0,2]):
            ...
            last_entry.unit_consumption = last_entry.unit_consumption + new_unit_consumption
            ...
            if(last_entry.fetch_fuel_data):
                last_record = DgUnitConsumption.objects.filter(site=int(site_id), is_dg_on=False).last()
                dg_start_date = int(last_record.dg_start_date.timestamp())
                dg_end_date = int(last_record.dg_end_date.timestamp())
                epoch_time = int(entry_time.timestamp() * 1000)
                fetch_fuel = roadcasteAPIUpdated(site.partner_dg_fuel_id, last_record.dg_start_date.date)
                if(fetch_fuel):
                    last_record.dg_fuel_consumption = fetch_fuel
                    last_record.save()
            DgUnitConsumption.objects.create(site=site, aisle_group=aisle_group[0],
            ...
            print("power source: ", aisle_group[0].power_source, " consumption : ", new_unit_consumption)
            print("power source is currently running is mains supply , making dg last entry off")
...
def mqtt_client1():
    ...
    def send_mail_for_alarms(site_id, aisle_id, alarm_type):
        ...
        if alarm_type == 0:  # for sensor by pass
            ...
            alarm = AlarmNotifications.objects.filter(site_id=site_id, aisle_group=aisle_id,
                                                      Alarm_type=0).order_by("-created_time")[0]
            ...
            msg = EmailMultiAlternatives(subject_mail, email, from_mail, [customer_mail, aviconn_user_mail])
            ...
            alarm = AlarmNotifications.objects.filter(site_id=site_id, aisle_group=aisle_id,
                                                      Alarm_type=1).order_by("-created_time")[0]
            alarm_name = alarm.get_Alarm_type_display()
            alarm_created_date = datetime.strftime(alarm.created_time, "%Y/%m/%d")
            print("alarm created date time is: ", alarm_created_date)
            email = ''
            ...
            alarm = AlarmNotifications.objects.filter(site_id=site_id, aisle_group=aisle_id,
                                                      Alarm_type=2).order_by("-created_time")[0]
            alarm_name = alarm.get_Alarm_type_display()
            alarm_created_date = datetime.strftime(alarm.created_time, "%Y/%m/%d")
            print("alarm created date time is: ", alarm_created_date)
            email = ''
            ...
            alarm = AlarmNotifications.objects.filter(site_id=site_id, aisle_group=aisle_id,
                                                      Alarm_type=3).order_by("-created_time")[0]
            alarm_name = alarm.get_Alarm_type_display()
            alarm_created_date = datetime.strftime(alarm.created_time, "%Y/%m/%d")
            print("alarm created date time is: ", alarm_created_date)
            email = ''
            ...
            alarm = AlarmNotifications.objects.filter(site_id=site_id, aisle_group=aisle_id,
                                                      Alarm_type=4).order_by("-created_time")[0]
            alarm_name = alarm.get_Alarm_type_display()
            alarm_created_date = datetime.strftime(alarm.created_time, "%Y/%m/%d")
            print("alarm created date time is: ", alarm_created_date)
            email = ''
            ...
            alarm = AlarmNotifications.objects.filter(site_id=site_id, aisle_group=aisle_id,
                                                      Alarm_type=5).order_by("-created_time")[0]
            alarm_name = alarm.get_Alarm_type_display()
            alarm_created_date = datetime.strftime(alarm.created_time, "%Y/%m/%d")
            print("alarm created date time is: ", alarm_created_date)
            email = ''
            ...
            alarm = AlarmNotifications.objects.filter(site_id=site_id, aisle_group=aisle_id,
                                                      Alarm_type=6).order_by("-created_time")[0]
            alarm_name = alarm.get_Alarm_type_display()
            alarm_created_date = datetime.strftime(alarm.created_time, "%Y/%m/%d")
            print("alarm created date time is: ", alarm_created_date)
            email = ''
            ...
            alarm = AlarmNotifications.objects.filter(site_id=site_id, aisle_group=aisle_id,
                                                      Alarm_type=7).order_by("-created_time")[0]
            alarm_name = alarm.get_Alarm_type_display()
            alarm_created_date = datetime.strftime(alarm.created_time, "%Y/%m/%d")
            print("alarm created date time is: ", alarm_created_date)
            email = ''
            ...
            alarm = AlarmNotifications.objects.filter(site_id=site_id, aisle_group=aisle_id,
                                                      Alarm_type=8).order_by("-created_time")[0]
            alarm_name = alarm.get_Alarm_type_display()
            alarm_created_date = datetime.strftime(alarm.created_time, "%Y/%m/%d")
            print("alarm created date time is: ", alarm_created_date)
            email = ''
            ...
            alarm = AlarmNotifications.objects.filter(site_id=site_id, aisle_group=aisle_id,
                                                      Alarm_type=9).order_by("-created_time")[0]
            alarm_name = alarm.get_Alarm_type_display()
            alarm_created_date = datetime.strftime(alarm.created_time, "%Y/%m/%d")
            print("alarm created date time is: ", alarm_created_date)
            email = ''
    ...
    def light_faulty_alarm(site_id, aisle_id, sensor_id, consumption, sensor_on_time):
        ...
        data = SiteStaticData.objects.filter(site_id=site_id, aisle_id=aisle_id, sensor_id=sensor_id)[0]
        ...
        if practical_consumption == current_consumption:
            ...
            if (practical_consumption - consmp) > current_consumption:
                print("raise alarm")
                alarm = AlarmNotifications.objects.create(created_by=customer, user_level=4, site_id=site_id,
                                                          object_type=3,
                                                          Alarm_type=1, Alarm_priority=1, created_time=datetime.now())
    ...
    def consumption_alarms(site_id, leg_id, current_consumption):
        ...
        daily = DailySiteReading.objects.filter(associated_Site=site_id, leg_id=leg_id, reading_for__gte=date.date())
        ...
        if current_consumption > total_max_consumption:
            ...
            high_alarm = AlarmNotifications.objects.create(created_by=None, user_level=2, site_id=site_id,
                                                           object_type=0,
            ...
            low_alarm = AlarmNotifications.objects.create(created_by=None, user_level=2, site_id=site_id,
                                                          object_type=0,
    ...
    def power_theft(site_id, current_consumption, baseline_value):
        ...
        if current_consumption > baseline_value:
            ...
            alarm = AlarmNotifications.objects.create(created_by=customer, user_level=4, site_id=site_id, object_type=0,
                                                      Alarm_type=2,
                                                      Alarm_priority=1, created_time=date)
            print("alarm : ", alarm)
    ...
    def on_message(client, userdata, msg):
        ...
        if 'consumption' in msg_type:
            try:
                ...
                # meter_reading= float()***************************
                current_hour_gw_unit_consumption = float(current_hour_total_consumption.split(":")[1])
                previous_hour_gw_unit_consumption = float(pervious_hour_total_consumption.split(":")[1])
                ...
                print("Consumption_time_in_secs = {}, New_unit_consumption = {}, Aisle_group_id = {}, Date = {}"
                      .format(consuption_time_in_sec, new_unit_consumption, aisle_group_id, message_time[0]))
                date = datetime.strptime(message_time[0], "%Y-%m-%d")
                dateHourLowerLimitCheck = date.replace(hour=int(message_time[1]), minute=0, second=0, microsecond=0)
                dateHourUpperLimitCheck = date.replace(hour=int(message_time[1]), minute=59, second=59, microsecond=0)
                print(dateHourLowerLimitCheck)
                print(dateHourUpperLimitCheck)
                aisle_entry = HourlySiteReading.objects.filter(associated_Site=int(location_id), leg_id=aisle_group_id)
                hourly_entry = aisle_entry.filter(reading_from__gte=dateHourLowerLimitCheck,
                                                  reading_from__lte=dateHourUpperLimitCheck)
                daily_entry = DailySiteReading.objects.filter(associated_Site=int(location_id), leg_id=aisle_group_id,
                                                              reading_for=date.date())
                print("Now checking condition for entry or update in hourly reading.")
                aisle_group = AisleGroup.objects.filter(site=site, attached_leg_id=str(aisle_group_id))
                ...
                if site.site_type == 1 and site.dg_fuel_system_installed:
                    try:
                        ...
                        try:
                            ...
                            entry_time = datetime.strptime(msg_time, "%Y-%m-%d %H:%M:%S")
                        print("entry time: ", entry_time)
                        hard_code_date = datetime.now().replace(year=2026,month=3, day=17)
                        dg_unit = DgUnitConsumption.objects.filter(site=int(location_id),created__date=hard_code_date.date())
                        if dg_unit.exists():
                            print("DgUnitConsumption entries are present for aisle : ", aisle_group_id)
                            last_entry = dg_unit.last()
                            check_dg_status = last_entry.is_dg_on
                            ...
                            if check_dg_status and aisle_group[0].power_source != 0:
                                #entry_time = datetime.strptime(msg_time, "%Y-%m-%d %H:%M:%S.%f")
                                epoch_time = int(entry_time.timestamp() * 1000)
                                print("dg is running continously from last entry, updating last entry")
                                last_entry.unit_consumption = last_entry.unit_consumption + new_unit_consumption
                                last_entry.epoch_time = epoch_time
                                last_entry.dg_end_date = entry_time
                                last_entry.save()
                                try:
                                    ...
                                    if ((last_entry.dg_end_date - last_entry.dg_start_date).seconds)/60 > site.dg_overtime:
                                        check_alarm_dg_overtime = NewAlarmsNotifications.objects.filter(site_id=site,
                                                                                                        alarm_type=3, created__gte=datetime.now() - timedelta(hours=2))
                                        if not check_alarm_dg_overtime.exists():
                                            NewAlarmsNotifications.objects.filter(site_id=site,
                                                                                  alarm_type=3, created=datetime.now())
                                            data = {"start_time": last_entry.dg_start_date, "end_time": last_entry.dg_end_date,
                                                    "site_id": site.id}
                                ...
                                if aisle_group[0].power_source != 0 and new_unit_consumption > 0:
                                    print("dg status gets off in previous time when data came, creating new entry")
                                    # getting fuel consumption of last entry
                                    print("fetching fuel consumption of last entry from loconav api")
                                    last_record = DgUnitConsumption.objects.filter(site=int(location_id), is_dg_on=False).last()
                                    dg_start_date = int(last_record.dg_start_date.timestamp())
                                    dg_end_date = int(last_record.dg_end_date.timestamp())
                                    if(location_id in [124, 118, 140, 153, 156,169]):
                                        fuel = roadcasteAPIUpdated(site.partner_dg_fuel_id, last_record.dg_start_date, last_record.dg_end_date)
                                    else:
                                        fuel = get_loconav_fuel_data(site.partner_dg_fuel_id, dg_start_date, dg_end_date)
                                    ...
                                    if aisle_group[0].power_source == 0 and new_unit_consumption > 0:
                                        ...
                                        if last_entry.is_dg_on:
                                            print("making dg last entry off at : ", datetime.now())
                                            last_entry.is_dg_on = False
                                            last_entry.save()
                                            print("dg status gets off in previous time when data came, creating new entry")
                                            # getting fuel consumption of last entry
                            ...
                            if aisle_group[0].power_source != 0 and new_unit_consumption > 0:
                                print("creating first ever entry for dg with aisle group: ", aisle_group_id)
                                #entry_time = datetime.strptime(message_time[0], "%Y-%m-%d %H:%M:%S")
                                epoch_time = int(entry_time.timestamp() * 1000)
                                DgUnitConsumption.objects.create(site=site, aisle_group=aisle_group[0],
                                                                 unit_consumption=new_unit_consumption,
                        ...
                        print("Exception while storing/updating dg unit consumption data : ", str(err))
                ...
                try:
                    ...
                    if sensor_aisle:
                        ...
                        print("msg time: ", msg_time)
                        entry_time = datetime.strptime(msg_time, "%Y-%m-%d %H:%M:%S.%f")
                        SensorAisleUnitConsumption.objects.create(associated_Site=site,aisle_group=aisle_group[0],
                                                              leg_id=aisle_group_id,
                                                              unit_consumption=new_unit_consumption, reading_for=entry_time)
                        print("data stored for leg : {} in sensor table".format(aisle_group_id))
                except Exception as err:
                ...
                if hourly_entry.exists():
                    ...
                    hourly_entry.update(unit_consumption=current_hour_gw_unit_consumption)
                    print("The hourly reading for leg id {} in site {} updated".format(aisle_group_id, site.site_name))
                else:
                    ...
                    print("Checking previous hour data entry for aisle group id {} of site {}.".format(aisle_group_id,
                                                                                                       site.site_name))
                    ...
                    previous_hour_entry = aisle_entry.filter(reading_from__gte=dateHourLowerLimitCheck1,
                                                             reading_from__lte=dateHourUpperLimitCheck1)
                    if previous_hour_entry.exists():
                        print("Checking for any loss in previous hour data.")
                        pervious_hour_server_unit_consumption = previous_hour_entry[0].unit_consumption
                        if pervious_hour_server_unit_consumption != previous_hour_gw_unit_consumption:
                            # for updating any gap in consumption between server's and gateway's hourly consumption.
                            consumption_gap = abs(
                                previous_hour_gw_unit_consumption - pervious_hour_server_unit_consumption)
                            print("This is the gap in server's last hour total consumption and"
                                  " gateway's last hour total consumption : {}".format(consumption_gap))
                            print("Updating the server hourly consumption with gateway hourly consumption.")
                            previous_hour_entry.update(unit_consumption=previous_hour_gw_unit_consumption)
                            print("Server hourly consumption synced with gateway hourly consumption.")
                        ...
                        if aisle_group_active:
                            aisle_group_baseline = SiteBaseline.objects.filter(associated_site_id=int(location_id),
                                                                               leg_id=str(aisle_group_id)).last()
                            ...
                            hourly_saving = leg_hourly_baseline - previous_hour_entry[0].unit_consumption
                            previous_hour_entry.update(energy_saved=hourly_saving)
                            print("Hourly saving of {} in {} of {} hour updated.".format(previous_hour_entry[0].leg_id,
                                                                                         site.site_name,
                                                                                         dateHourLowerLimitCheck1))
                        # Creating new hour entry after receving first packet of new hour  #########
                        print("Creating new entry in hourly consumption table for aisle group id {} of site {}.".format(
                        ...
                        if daily_entry.exists():
                            ...
                            if dateofDailyEntry == date.date():
                                ...
                                oneDayHourlyData = HourlySiteReading.objects.filter(associated_Site=site,
                                ...
                                for hourlyloop in oneDayHourlyData:
                                    totalConsumptionofAllHours += hourlyloop.unit_consumption
                                    print("Daily consumption as per all hours :", totalConsumptionofAllHours)
                                print("Daily entry units before updating is :", dailyUnitConsumption)
                                if totalConsumptionofAllHours != dailyUnitConsumption:
                                    ...
                                    daily_entry_instance.unit_consumption = totalConsumptionofAllHours
                                    daily_entry_instance.save()
                                    print("daily unit after update", daily_entry[0].unit_consumption)
                                    print("Now daily entry synced with sum of hourly data")

                                else:
                                    print("Daily and hourly buckets both are already in  synced")
                            else:
                                print("Daily entry Date not equal to packet date")
                        else:
                            ### Handling if daily entry doesnot exists.######
                            print("This is not possible why daily entry doesnot created")

                        HourlySiteReading.objects.create(associated_Site=site, aisle_group=aisle_group[0],
                                                         leg_id=aisle_group_id,
                                                         unit_consumption=new_unit_consumption,
                                                         ...
                                                         is_visible=True)
                        print("New hourly entry for leg id {} is created.".format(aisle_group_id))
                    else:
                        if aisle_entry.count() > 0:  # If not the first ever entry for this aisle group on this site.
                            print("No previous hour entry found for this aisle group, data loss suspected.")
                            last_hourly_entry = HourlySiteReading.objects.filter(associated_Site=int(location_id),
                                                                                 leg_id=aisle_group_id).last()
                            print("abhishek's debugging start")
                            print(last_hourly_entry)

                            print("This is the time for last entry for this aisle group : {}".format(
                            ...
                            print("Sending command to gateway to sync data for recovery for this aisle group.")
                            topictosend = "/Acclivate/iOmniControl/" + str(location_id) + "/" + \
                                          str(gw_id) + "/in/" + "sync/consumption" + "/state"
                            last_hourly_entry_time = datetime.strftime(last_hourly_entry.reading_to,
                                                                       "%Y-%m-%d %H:%M:%S.%f")
                            msg = "Missed_consumption_time_in_secs :" + str(time_gap.total_seconds()) + \
                                  ",Aisle_grp :" + str(aisle_group_id) + \
                                  ",Last_Synced_hour :" + last_hourly_entry_time
                            ...
                            DailySiteReading.objects.create(associated_Site=site, aisle_group=aisle_group[0],
                                                            leg_id=aisle_group_id,
                                                            unit_consumption=new_unit_consumption,
                ...
                if daily_entry.exists():
                    ...
                    daily_entry.update(unit_consumption=new_consumption, energy_saved=(site_baseline - new_consumption),
                                       daily_baseline_value=site_baseline)
                    ...
                    DailySiteReading.objects.create(associated_Site=s, aisle_group=aisle_group[0],
                                                    leg_id=aisle_group_id,
                                                    unit_consumption=new_unit_consumption,
                                                    daily_baseline_value=site_baseline,
                                                    reading_for=date.date(),
                                                    is_visible=True)
                    print("New daily entry for leg id {} is created.".format(aisle_group_id))
                    print("Checking for high or low consumption in this aisle group.")
                    current_consumption = DailySiteReading.objects.filter(associated_Site=s, leg_id=aisle_group_id,
                                                                          reading_for=(
            ...
            if len(fire_alarm_data):
                ...
                try:
                    ...
                    fire_pump_alarm = FirePumpAlarm.objects.filter(Site=site, Meter_Number=meter_number)
                    ...
                    if fire_pump_alarm.exists():
                        ...
                        fire_pump_alarm.update(r_volt=r_volt, y_volt=y_volt, b_volt=b_volt,
                                               motor_status=power_status, Meter_Number=meter_number,
                        ...
                        if updated_r_volt > 200 and updated_y_volt < 100 and updated_b_volt > 200 and power_status == 1:
                            print("motor on in auto mode")
                            alarm_type = "Motor-On in Auto-Mode"
                            check_previous_mail = Email_History.objects.filter(fire_site=site,
                                                                               deviceName=aisleGrpObject,
                                                                               email_for=5).order_by('-created')
                            if check_previous_mail.exists():
                                ...
                                if difference.total_seconds() > mail_difference_time:
                                    print("sending mail, difference is more than 10 minutes")
                                    send_email = send_mail_fire_alarm_user(user_email, alarm_type, deviceName,
                                                                           power_status)
                                    Email_History.objects.create(fire_site=site, deviceName=aisleGrpObject, email_for=5,
                                                                 created=datetime.now())
                                else:
                                    print("last mail sent 10 minutes before")
                            else:
                                print("sending first mail for motor on condition in auto mode")
                                send_email = send_mail_fire_alarm_user(user_email, alarm_type, deviceName, power_status)
                                Email_History.objects.create(fire_site=site, deviceName=aisleGrpObject, email_for=5,
                                                             created=datetime.now())
                        if updated_r_volt < 100 and updated_y_volt > 200 and updated_b_volt > 200 and power_status == 1:
                            ...
                            if check_previous_mail.exists():
                                ...
                                print("sending first mail for motor on condition in manual mode")
                                send_email = send_mail_fire_alarm_user(user_email, alarm_type, deviceName, power_status)
                                Email_History.objects.create(fire_site=site, deviceName=aisleGrpObject, email_for=5,
                                                             created=datetime.now())
                        if updated_r_volt > 200 and updated_y_volt < 100 and updated_b_volt > 200 and initial_r_volt < 100 and initial_y_volt > 200 and initial_b_volt > 200:
                            print("manual-mode to auto-mode")
                            alarm_type = "Manual-Mode to Auto-Mode"
                            send_email = send_mail_fire_alarm_user(user_email, alarm_type, deviceName, power_status)
                            Email_History.objects.create(fire_site=site, deviceName=aisleGrpObject, email_for=2,
                                                         created=datetime.now())

                        elif initial_r_volt > 200 and initial_y_volt < 100 and initial_b_volt > 200 and updated_r_volt < 100 and updated_y_volt > 200 and updated_b_volt > 200:
                            print("auto mode to manual mode")
                            alarm_type = "Auto-Mode to Manual-Mode"
                            send_email = send_mail_fire_alarm_user(user_email, alarm_type, deviceName, power_status)
                            print("send_email", send_email)
                            Email_History.objects.create(fire_site=site, deviceName=aisleGrpObject, email_for=1,
                                                         created=datetime.now())

                        elif initial_r_volt > 200 and initial_y_volt < 100 and initial_b_volt > 200 and updated_r_volt < 100 and updated_y_volt < 100 and updated_b_volt > 200:
                            print("auto to off")
                            alarm_type = "Auto-Mode to Off-Mode"
                            send_email = send_mail_fire_alarm_user(user_email, alarm_type, deviceName, power_status)
                            Email_History.objects.create(fire_site=site, deviceName=aisleGrpObject, email_for=4,
                                                         created=datetime.now())
                        elif initial_r_volt < 100 and initial_y_volt < 100 and initial_b_volt > 200 and updated_r_volt < 100 and updated_y_volt < 100 and updated_b_volt > 200:
                            print("manual to off")
                            alarm_type = "Manual-Mode to Off-Mode"
                            send_email = send_mail_fire_alarm_user(user_email, alarm_type, deviceName, power_status)
                            Email_History.objects.create(fire_site=site, deviceName=aisleGrpObject, email_for=4,
                                                         created=datetime.now())
                        elif initial_r_volt < 100 and initial_y_volt < 100 and initial_b_volt > 200 and updated_r_volt > 200 and updated_y_volt < 100 and updated_b_volt > 200:
                            print("off to auto")
                            alarm_type = "Off-Mode to Auto-Mode"
                            send_email = send_mail_fire_alarm_user(user_email, alarm_type, deviceName, power_status)
                            Email_History.objects.create(fire_site=site, deviceName=aisleGrpObject, email_for=2,
                                                         created=datetime.now())
                        elif initial_r_volt < 100 and initial_y_volt < 100 and initial_b_volt > 200 and updated_r_volt < 100 and updated_y_volt > 200 and updated_b_volt > 200:
                            print("off to manual")
            ...
            try:
                ...
                load_entry = SiteLoadPower.objects.filter(Associated_Site=int(location_id), Supply_Source=power_source,
                                                          Meter_Number=meter_number)
                if site.show_voltage_alarms and (r_volts > 0 and y_volts > 0 and b_volts > 0):
                    print("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$")
                    ...
                    print("creating  enrty for high voltage data",b_phase_voltage_threshold_max,type(b_phase_voltage_threshold_max))
                    parameter = SiteLoadParameters.objects.create(site_id=site, power_source=power_source, parameter_type=0,
                                                                  r_phase=r_volts, y_phase=y_volts, b_phase=b_volts,
                                                                  meter_number=meter_number, created=datetime.now())
                    fetch_last_entries = SiteLoadParameters.objects.filter(site_id=site, power_source=power_source, parameter_type=0).order_by('-created')
                    ...
                    if fetch_last_entries.count() > 6:
                        ...
                        for i in fetch_last_entries[0:5]:
                            print("r_Phase value for high vlotage:",i.r_phase,i.y_phase,type(i.b_phase))
                            if r_phase_voltage_threshold_max < float(i.r_phase) or y_phase_voltage_threshold_max < float(i.y_phase) or b_phase_voltage_threshold_max < float(i.b_phase):
                        ...
                        if check_high_volt_alarm:
                            ...
                            alarm = NewAlarmsNotifications.objects.filter(site_id=site, alarm_type=0, power_source=power_source, created__gte=datetime.now() - timedelta(minutes=30))
                            if not alarm.exists():
                                print("create alarm")
                                NewAlarmsNotifications.objects.create(site_id=site, alarm_type=0,
                                                                      power_source=power_source,
                                                                      created=datetime.now(), alarm_priority=0,
                                                                      r_phase=r_volts, y_phase=y_volts, b_phase=b_volts)
                                data = {"r_volts": round(r_volts,2), "y_volts": round(y_volts,2), "b_volts": round(b_volts,2),
                                        "r_volt_threshold": r_phase_voltage_threshold_max,
                                        "y_volt_threshold": y_phase_voltage_threshold_max,
                                        "b_volt_threshold": b_phase_voltage_threshold_max, "site_id": site.id}
                                send_alarm_for_high_voltage(data)
                                print("################### send mail for high Voltage###################")
                    print("creating entry for low voltage data")
                    parameter = SiteLoadParameters.objects.create(site_id=site, power_source=power_source,
                                                                  parameter_type=1,
                                                                  r_phase=r_volts, y_phase=y_volts, b_phase=b_volts,
                                                                  meter_number=meter_number, created=datetime.now())
                    fetch_last_entries = SiteLoadParameters.objects.filter(site_id=site, power_source=power_source,
                                                                           parameter_type=1).order_by('-created')
                    print("fetch_last_entries for low voltage : ",fetch_last_entries)
                    if fetch_last_entries.count() > 6:
                        check_low_volt_alarm = True
                        for i in fetch_last_entries[0:5]:
                            print("r_Phase value for low vlotage:",i.r_phase,i.y_phase,type(i.b_phase))
                            if r_phase_voltage_threshold_min > float(i.r_phase) or y_phase_voltage_threshold_min > float(i.y_phase) or b_phase_voltage_threshold_min > float(i.b_phase):
                                print("@@@@@@@@@@@@@@@@@@@@@ Low voltage @@@@@@@@@@@@@@@@@@@")
                            else:
                                check_low_volt_alarm = False
                                break
                        if check_low_volt_alarm:
                            alarm = NewAlarmsNotifications.objects.filter(site_id=site, alarm_type=1,
                                                                          power_source=power_source,
                                                                          created__gte=datetime.now() - timedelta(minutes=30))
                            if not alarm.exists():
                                print("generate alarm for low consumption")
                                NewAlarmsNotifications.objects.create(site_id=site, alarm_type=1,
                                                                      power_source=power_source,
                                                                      created=datetime.now(), alarm_priority=0,
                                                                      r_phase=r_volts, y_phase=y_volts, b_phase=b_volts)
                                data = {"r_volts": r_volts, "y_volts": y_volts, "b_volts": b_volts,
                                        "r_volt_threshold": r_phase_voltage_threshold_min,
                                        "y_volt_threshold": y_phase_voltage_threshold_min,
                                        "b_volt_threshold": b_phase_voltage_threshold_min, "site_id": site.id}
                ...
                if load_entry.exists():
                    ...
                    if site.is_pf_visible:
                        if len(load) == 14:
                            ...
                            print("power factors value for r-phase : {}, y-phase: {}, b-phase: {}".format(r_pf, y_pf,
                                                                                                          b_pf))
                            ...
                            if status == "ON":
                                try:
                                    ...
                                    pf_check = False
                                    pf = PowerFactorData(site=site, supply_source=power_source,
                                                         meter_number=meter_number,
                                                         created=datetime.now())
                                    ...
                                    if b_pf < b_phase_threshold:
                                        ...
                                        pf_check = True
                                    if pf_check:
                                        print("creating entry for pf fluctuation reference to threshold value")
                                        pf.save()
                                        pf_data = {"r_pf": r_pf, "y_pf": y_pf, "b_pf": b_pf, "r_pf_threshold": r_phase_threshold,
                                                   "y_pf_threshold": y_phase_threshold, "b_pf_threshold": b_phase_threshold,
                                                   "site_id": site.id, "power_source": power_source
                                                   }

                                        try:
                                            check_already_alarm = NewAlarmsNotifications.objects.filter(site_id=site,
                                                                                                        power_source=power_source,
                                                                                                        alarm_type=2, created__gte=datetime.now() - timedelta(minutes=30))
                                            if not check_already_alarm.exists():
                                                alarm = NewAlarmsNotifications.objects.create(site_id=site,
                                                                                              power_source=power_source,
                                                                                              alarm_type=2, alarm_priority=1,
                                                                                              created=datetime.now(), r_phase=r_pf,
                                                                                              y_phase=y_pf, b_phase=b_pf
                                                                                              )
                                                send_mail_for_pf_fluctuation(pf_data)
                                                print("mail send successfully for bad pd for site: ", site.site_name)
                                        except Exception as err:
                                            print("Error in sending mail for bad pf for site : ", site.site_name)
                                except Exception as err:
                                    print("Error in power faction fluctuation record creation logic: ", err)

                    load_entry.update(Associated_Site=site, Site_Total_Load=load_power,
                                      r_volt=r_volts, y_volt=y_volts, b_volt=b_volts,
                                      r_power_factor=r_pf, y_power_factor=y_pf, b_power_factor=b_pf,
                                      r_current=r_currents, y_current=y_currents, b_current=b_currents, Status=status,
                                      Updated_on=datetime.now())

                    print("site load table  parameters updated.")
                else:
                    print("Creating the first entry for supply {} for site {}.".format(power_source, site))
                    SiteLoadPower.objects.create(Associated_Site=site, Site_Total_Load=load_power, r_volt=r_volts,
                                                 y_volt=y_volts,
                                                 min_load=load_power, max_load=load_power,
                                                 b_volt=b_volts, r_current=r_currents, y_current=y_currents,
                                                 b_current=b_currents,
                                                 Supply_Source=power_source, Meter_Number=meter_number, Status=status,
                                                 Updated_on=datetime.now())
            ...
            try:
                ...
                print("date : ", date)
                dateHourLowerLimitCheck = date.replace(hour=int(message_date_time[1]), minute=0, second=0,
                                                       microsecond=0)
                print(dateHourLowerLimitCheck)
                dateHourUpperLimitCheck = date.replace(hour=int(message_date_time[1]), minute=59, second=59,
                                                       microsecond=0)
                print(dateHourUpperLimitCheck)
                run_time = SupplyLoadTimeShare.objects.filter(site=int(location_id), power_source=source)
                current_hour_runtime = run_time.filter(reading_from__gte=dateHourLowerLimitCheck,
                                                       reading_from__lte=dateHourUpperLimitCheck)
                ...
                if current_hour_runtime.exists():
                    ...
                    new_run_time = current_hour_runtime[0].hourly_run_time + source_run_time
                    ...
                    try:
                        ...
                        print("Creating new entry for run time of {} in {}".format(source, site))
                        ...
                        if today.month != monthly_load_share.month and today > monthly_load_share:
                            ...
                            total_time = sum([i.hourly_run_time for i in monthly_total_run_time])
                            print("Total runtime for last month = {}".format(total_time))
                            for j in monthly_run_time.distinct('power_source'):
                                single_power_monthly_runtime = monthly_total_run_time.filter(
                                    power_source=j.power_source)
                                print("Calculating and creating entry for power source {} for site {}".format(
                                    j.power_source, site.site_name))
                                single_source_total_time = sum(
                                    [i.hourly_run_time for i in single_power_monthly_runtime])
                                single_source_percentage = (single_source_total_time / total_time) * 100
                                print("The time based run percentage for power source {} is {}".format(j.power_source,
                                ...
                                MonthlyLoadSharePercentage.objects.create(site=site, power_source=j.power_source,
                                                                          monthly_time_based_percentage=single_source_percentage,
                                                                          for_month=for_month)
                                print("Monthly entry created for {} for power source {} for site {}".format(for_month,
                                                                                                            j.power_source,
                                                                                                            site.site_name))
                    except Exception as err:
                        print("exception in monthly load share percentage table : ", err)
                    print("Find the last value of total run time.")
                    dateHourLowerLimitCheck1 = dateHourLowerLimitCheck - timedelta(hours=1)
                    dateHourUpperLimitCheck1 = dateHourUpperLimitCheck - timedelta(hours=1)
                    previous_hour_run_time = run_time.filter(reading_from__gte=dateHourLowerLimitCheck1,
                                                             reading_from__lte=dateHourUpperLimitCheck1)
                    if previous_hour_run_time.exists():
                        ...
                        SupplyLoadTimeShare.objects.create(site=site, power_source=source,
                                                           hourly_run_time=source_run_time,
                                                           reading_from=dateHourLowerLimitCheck,
                                                           reading_to=dateHourUpperLimitCheck)
                        print("New hourly run time entry for {} in {} created.".format(source, site))
                    else:
                        if run_time.count() > 0:  # If not the first ever entry for this site.
                            print("Previous hour entry not found, data loss suspected.")
                            last_runtime_entry = run_time.last()
                            loss_time = (today - last_runtime_entry.reading_from).total_seconds()
                            last_synced_hour = datetime.strftime(last_runtime_entry.reading_from,
                                                                 "%Y-%m-%d %H:%M:%S.%f")
                            print("Reading lost for {} seconds.".format(loss_time))
                            print("Starting recovery mechanism for runtime data for source {}".format(source))
                            topictosend = "/Acclivate/iOmniControl/" + str(location_id) + "/" + \
                                          gw_id + "/in/" + "sync" + "/loadTime" + "/state"
                            msg = "Power_source : " + str(source) + \
                                  ", Missed_consumption_time_in_secs : " + str(loss_time) + \
                                  ", Last_synced_hour : " + last_synced_hour
                            client.publish(topictosend, msg, qos=0, retain=False)
                            print("Recovery message for runtime sent to {} gateway for power source {}.".format(site,
                                                                                                                source))
                        else:
                            ...
                            SupplyLoadTimeShare.objects.create(site=site, power_source=source,
                                                               ...
                                                               reading_from=dateHourLowerLimitCheck,
                                                               reading_to=dateHourUpperLimitCheck)
                            print("First ever hourly run time entry for {} in {} created.".format(source, site))
            except Exception as e:
        ...
        if "recovery" in msg_type:
            if "dailyConsumption" in msg_subtype:
                try:
                    print("Starting recovery for daily consumption for site {}.".format(site))
                    aisle_group_id, recovery_dates, unit_consumptions, gw_total_cumulative = re.search(
                        r'Aisle_group_id : (.*); Recovery_Dates : (.*); Unit_consumptions : (.*);'
                        r' GW_Total_cumulative : (.*)', message).groups()
                    dates = recovery_dates.split(",")
                    daily_consumptions = unit_consumptions.split(",")
                    # daily_consumptions = map(float, consumptions)
                    aisle_group = AisleGroup.objects.filter(site=site, attached_leg_id=aisle_group_id)
                    aisle_group_status, aisle_group_active, daily_saving = False, False, 0.0
                    if aisle_group[0].is_visible:
                        aisle_group_status = True
                    if aisle_group[0].is_active:
                        aisle_group_active = True
                    ...
                    for i in range(len(dates) - 1):
                        ...
                        daily_entry = DailySiteReading.objects.filter(associated_Site=site, leg_id=aisle_group_id,
                                                                      reading_for=date)
                        ...
                        if aisle_group_active:
                            ...
                            if aisle_group_baseline:
                                aisle_group_baseline = aisle_group_baseline[0].baseline_value
                            else:
                                aisle_group_baseline = SiteBaseline.objects.filter(associated_site_id=int(location_id),
                                                                                   leg_id=str(
                                                                                       aisle_group_id)).last().baseline_value
                            print("Now calculating saving for {}.".format(date))
                            daily_saving = aisle_group_baseline - daily_unit_consumption
                        if daily_entry.exists():
                            print("Updating the recovery unit in aisle group {} for {}".format(aisle_group_id, date))
                            if daily_entry[0].unit_consumption < daily_unit_consumption:
                                daily_entry.update(unit_consumption=daily_unit_consumption,
                                                daily_baseline_value=aisle_group_baseline,
                                                energy_saved=daily_saving)
                                print(
                                    "Updated with {} units consumption and {} units saving.".format(daily_unit_consumption,daily_saving))
                            else:
                                print("Existing daily unit consumption is greater , so no update:{} -- {} -- {}".format(aisle_group_id, daily_entry[0].unit_consumption, daily_unit_consumption))
                        else:
                            ...
                            DailySiteReading.objects.create(associated_Site=site, aisle_group=aisle_group[0],
                                                            ...
                                                            daily_baseline_value=aisle_group_baseline,
                                                            energy_saved=daily_saving,
                                                            reading_for=date, is_visible=True)
                            print("Consumption and saving calculated and recovered for {}.".format(aisle_group_id))
                except Exception as e:
                ...
                try:
                    print("Starting recovery for hourly consumption for site {}.".format(site))
                    ...
                    for i in range(len(hours) - 1):
                        ...
                        print(dateHour)
                        dateHourLowerLimitCheck = dateHour.replace(minute=0, second=0, microsecond=0)
                        dateHourUpperLimitCheck = dateHour.replace(minute=59, second=59, microsecond=0)
                        ...
                        hourly_entry = HourlySiteReading.objects.filter(associated_Site=site, leg_id=aisle_group_id,
                                                                        reading_from=dateHourLowerLimitCheck,
                                                                        reading_to=dateHourUpperLimitCheck)
                        ...
                        if aisle_group_active:
                            ...
                            if aisle_group_baseline:
                                leg_hourly_baseline = aisle_group_baseline[0].baseline_value / aisle_group_baseline[
                                    0].working_hours
                            else:
                                aisle_group_baseline = SiteBaseline.objects.filter(associated_site_id=int(location_id),
                                                                                   leg_id=str(aisle_group_id)).last()
                        ...
                        if hourly_entry.exists():
                            print(
                                "Updating the recovery unit in aisle group {} for {}".format(aisle_group_id, dateHour))
                            hourly_entry.update(unit_consumption=hourly_unit_consumption,
                                                hourly_baseline_value=leg_hourly_baseline,
                                                energy_saved=hourly_saving)
                            print(
                                "Updated with {} units consumption and {} units saving.".format(hourly_unit_consumption,
                                                                                                daily_saving))
                        else:
                            print("Creating new hourly consumption entry for recovery of {} for {}.".format(
                            ...
                            HourlySiteReading.objects.create(associated_Site=site, aisle_group=aisle_group[0],
                                                             ...
                                                             reading_to=dateHourUpperLimitCheck,
                                                             is_visible=True)
                            print("Hourly consumption and saving calculated and recovered.")
                except Exception as e:
                ...
                try:
                    powerSource, recovery_hours, recovery_load_time = re.search(
                        "Power_source : (.*); Recovery_hours : (.*); Recovery_load_runtime : (.*)", message).groups()
                    power_source = SupplyLoadTimeShare.objects.filter(site=site, power_source=int(powerSource))
                    recovery_hours = recovery_hours.split(",")
                    recovery_load_runtime = recovery_load_time.split(",")
                    print("This is the load runtime recovery message for {} in {}."
                          .format(power_source[0].get_power_source_display(), site))
                    for i in range(len(recovery_hours) - 1):
                        entry_datetime = datetime.strptime(recovery_hours[i], "%Y-%m-%d %H:%M:%S.%f")
                        ...
                        if runtime_entry.exists():
                            ...
                            print("Creating new entry for recovery of hour {}".format(entry_datetime))
                            SupplyLoadTimeShare.objects.create(site=site, power_source=int(powerSource),
                                                               hourly_run_time=load_runtime,
                                                               reading_from=entry_datetime,
                                                               reading_to=entry_datetime.replace(minute=59, second=59))
                            print("New entry successfully created for recovery of hour {}".format(entry_datetime))
                except Exception as e:
...
def mqtt_client2():
    ...
    #             print(f"Site not found for site_id: {site_id}")
    #             return False
    ...
    #         if max_threshold_value is None or min_threshold_value is None:
    #             print("Site min or max threshold value is not set, skipping alarm calculation.")
    #             return False
    ...
    #             leg_id=leg_id, 
    #             reading_for__gte=date.date(),
    #             reading_for__lt=current_date.date()
    #         )
            
    #         count = daily.count()
    #         if count == 0:
    #             print("Not enough daily data to calculate average consumption.")
    #             return True

    #         unit_consumption = sum(i.unit_consumption for i in daily)
    #         average_consumption = unit_consumption / count
    ...
    #         if current_consumption > total_max_consumption:
    #             print(f"high consumption alarm for site {site.site_name}")
    #             if not AlarmNotifications.objects.filter(site_id=site_id, aisle_group_id=leg_id, Alarm_type=7, created_time__gte=start_of_day).exists():
    #                 high_alarm = AlarmNotifications.objects.create(
    #                     created_by=customer, user_level=4, site_id=site_id,
    #                     object_type=0, aisle_group_id=leg_id,
    #                     Alarm_type=7, Alarm_priority=1, created_time=current_date
    #                 )
    #                 print("high alarm generated: ", high_alarm)
    #                 # send_mail_for_alarms(site_id, leg_id, 7)
    #             else:
    #                 print("High consumption alarm already generated today.")
    #         elif current_consumption < total_min_consumption:
    #             print(f"low consumption alarm for site {site.site_name}")
    #             if not AlarmNotifications.objects.filter(site_id=site_id, aisle_group_id=leg_id, Alarm_type=8, created_time__gte=start_of_day).exists():
    ...
    #             else:
    #                 print("Low consumption alarm already generated today.")
    #         else:
    #             print(f"For site {site.site_name}, the consumption is nearly as average of past days.")
    #         return True
    #     except Exception as e:
    #         print(f"Exception in consumption_alarms for site_id {site_id}: {str(e)}")
    #         return False
    ...
    def consumption_alarms(site_id, leg_id, current_consumption):
        ...
        try:
            ...
            count = daily.count()
            if count == 0:
                logger.info(f"Not enough daily data to calculate average consumption for site {site_id}.")
                return True

            # Safely cast to float and handle potential None values
            unit_consumptions = [float(i.unit_consumption or 0.0) for i in daily]
            average_consumption = sum(unit_consumptions) / count
            
            if max_threshold_value is not None and min_threshold_value is not None:
                max_consumption = (average_consumption * max_threshold_value) / 100
                min_consumption = (average_consumption * min_threshold_value) / 100
                total_max_consumption = round(average_consumption + max_consumption, 2)
                total_min_consumption = round(average_consumption - min_consumption, 2)
            else:
                # Fallback to dynamic threshold using Standard Deviation
                if count > 1:
                    variance = sum((x - average_consumption) ** 2 for x in unit_consumptions) / (count - 1)
                    # max(0.0, variance) prevents math domain errors from floating point imprecision
                    std_dev = math.sqrt(max(0.0, variance))
                else:
                    std_dev = 0.0
                
                # Ensure a minimum standard deviation of 10% of the average to avoid overly sensitive alarms
                min_std_dev = average_consumption * 0.10
                if std_dev < min_std_dev:
                    std_dev = min_std_dev
                
                total_max_consumption = round(average_consumption + (2 * std_dev), 2)
                total_min_consumption = round(average_consumption - (2 * std_dev), 2)
                
                if total_min_consumption < 0:
                    total_min_consumption = 0
            
            start_of_day = current_date.replace(hour=0, minute=0, second=0, microsecond=0)

            if current_consumption > total_max_consumption:
                logger.warning(f"High consumption alarm triggered for site {site.site_name} (Current: {current_consumption}, Max Allowed: {total_max_consumption})")
                if not AlarmNotifications.objects.filter(site_id=site_id, aisle_group_id=leg_id, Alarm_type=7, created_time__gte=start_of_day).exists():
                    high_alarm = AlarmNotifications.objects.create(
                        created_by=None, user_level=2, site_id=site_id,
                        object_type=0, aisle_group_id=leg_id,
                        Alarm_type=7, Alarm_priority=1, created_time=current_date
                    )
                    logger.info(f"High alarm successfully generated: {high_alarm.id}")
                else:
                    logger.info(f"High consumption alarm already generated today for site {site.site_name}.")
            elif current_consumption < total_min_consumption:
                logger.warning(f"Low consumption alarm triggered for site {site.site_name} (Current: {current_consumption}, Min Allowed: {total_min_consumption})")
                if not AlarmNotifications.objects.filter(site_id=site_id, aisle_group_id=leg_id, Alarm_type=8, created_time__gte=start_of_day).exists():
                    low_alarm = AlarmNotifications.objects.create(
                        created_by=None, user_level=2, site_id=site_id,
                        object_type=0, aisle_group_id=leg_id,
                    ...
                    logger.info(f"Low alarm successfully generated: {low_alarm.id}")
                else:
                    logger.info(f"Low consumption alarm already generated today for site {site.site_name}.")
            else:
                logger.info(f"For site {site.site_name}, the consumption ({current_consumption}) is within normal bounds ({total_min_consumption} - {total_max_consumption}).")
            return True
        except Exception as e:
            logger.exception(f"Exception in consumption_alarms for site_id {site_id}: {str(e)}")
            return False
    ...
    def on_message(client, userdata, msg):
        ...
        if "LoadData" in msg_type:
            ...
            load_aisle_group = AisleGroup.objects.filter(site=site, attached_leg_id=str(load_leg_id))
            print("load_aisle_group :", load_aisle_group)
            # raw load data logic starts here
            RawLoadData.objects.create(site=site, aisle_group=load_aisle_group[0],
                                       load_data=load_value, created=load_date,
                                       epoch_time=load_epoch_time)
            print("raw entry created for {} site with leg id {} of load value {} at {}".format(locationId,
                                                                                               load_leg_id,
                                                                                               load_value,
                                                                                               datetime.now()))
            ...
            if site.is_loadGraph_visible:
                ...
                load_entry = SiteLoadPower.objects.filter(Associated_Site=int(location_id),
                                                          Meter_Number=meter_number)
                print("load entry ", load_entry)
                print("checking for monthly min max load")
                try:
                    today_date = datetime.now()
                    monthly_min_max_load = MonthlyMinMaxLoadData.objects.filter(site=site, supply_source=power_source,
                    ...
                    if monthly_min_max_load.exists():
                        ...
                        print("monthly_min_load: ", monthly_min_load, "monthly_max_load: ", monthly_max_load,
                              "current load: ", load_value)
                        if monthly_min_load > load_value:
                            print("updating min load")
                            monthly_min_max_load.update(min_load=load_value, min_load_created=today_date)
                            if load_entry.exists():
                        ...
                        if monthly_max_load < load_value:
                            ...
                            monthly_min_max_load.update(max_load=load_value, max_load_created=today_date)
                            if load_entry.exists():
                                load_entry.update(max_load=load_value)
                    else:
                        print("creating first entry for this month")
                        MonthlyMinMaxLoadData.objects.create(site=site, min_load=load_value, max_load=load_value,
                                                             min_load_created=today_date, max_load_created=today_date,
                                                             created=today_date, supply_source=power_source)
                except Exception as err:
            ...
            if load_date.date() == previous_minute.date() and load_date.hour == previous_minute.hour:
                print("checking hourly entry for current data")
                try:
                    load_hourly = HourlyLoadData.objects.filter(site=site,
                    ...
                    if not load_hourly.exists():
                        print(
                            "Trying to create min, max load hourly  entry of {} minute, {} hour of site {} , aisle group {} at {}".format(
                                load_minute, load_hour, locationId, load_leg_id, datetime.now()))
                        ...
                        for leg in all_leg_id:
                            raw_load = RawLoadData.objects.filter(site=site, aisle_group=leg.id,
                                                                  created__date=load_date.date(),
                                                                  created__hour=load_hour,
                                                                  created__minute=load_minute - 1)
                                ...
                                if raw_load.exists():
                                    ...
                                    try:
                                        if int(min_epoch_time) < int(max_epoch_time):
                                            HourlyLoadData.objects.create(site=site, aisle_group=leg,
                                                                          load_data=min_load,
                                                                          created=min_created,
                                                                          epoch_time=min_epoch_time)
                                            print(
                                                "Hourly entry created successfull for minimum load {} of {} site with leg id {}  at {}".format(
                                                    min_load, locationId, leg.aisleGroupName, datetime.now()))
                                            HourlyLoadData.objects.create(site=site, aisle_group=leg,
                                                                          load_data=max_load,
                                                                          created=max_created,
                                            ...
                                            print(
                                                "Hourly entry created successfull for max load {} of {} site with leg id {}  at {}".format(
                                                    max_load, locationId, leg.aisleGroupName, datetime.now()))

                                            MainsDgLoadData.objects.create(site=site, aisle_group=leg,
                                                                           load_data=min_load,
                                                                           created=min_created,
                                                                           epoch_time=min_epoch_time)
                                            print(
                                        ...
                                        print("Error while storing load data in mains dg table", err)
                            else:
                                print("storing zero load data in mains dg table for leg {} of site {} at {}".format(
                                    locationId, leg.aisleGroupName, datetime.now()))
                                if int(min_epoch_time) < int(max_epoch_time):
                                    MainsDgLoadData.objects.create(site=site, aisle_group=leg,
                                                                   load_data=0,
                                                                   created=min_created, epoch_time=min_epoch_time)
                                    print(
            ...
            if load_date.date() == previous_hour.date():
                ...
                try:
                    load_daily_entry = DailyLoadData.objects.filter(site=site,
                                                                    created__date=load_date.date(),
                    ...
                    if not load_daily_entry.exists():
                        ...
                        all_leg_id = AisleGroup.objects.filter(site=site)
                        for leg in all_leg_id:
                            load_hourly_entry = HourlyLoadData.objects.filter(site=site, aisle_group=leg.id,
                                                                              created__date=load_date.date(),
                                                                              created__hour=load_hour - 1)
                            if load_hourly_entry.exists():
                                ...
                                for i in load_hourly_entry:
                                    ...
                                    if max_load < load:
                                        ...
                                        max_created = i.created
                                if int(min_epoch_time) < int(max_epoch_time):
                                    DailyLoadData.objects.create(site=site, aisle_group=leg,
                                                                 created=min_created,
                                                                 load_data=min_load,
                                                                 epoch_time=min_epoch_time)
                                    print(
