...
def get_fuel_data_roadcaste():
    try:
        ...
        for i in data:
            ...
            if status:
                print('created a fuel entry for site {s.site_name} having a fuel level of {r.fuel_consumption}')
    except Exception as error:
        print(str(error))
    

def get_fuel_data_loconav():
    print("inside loconav")
        ...
        for site in sites:
            ...
            if v:
                ...
                if(data):
                    ...
                    if(status):
                        print('created a fuel entry for site {site.site_name} having a fuel level of {r.fuel_consumption}')
                else:
                    print("Got no response!! perhaps the API failed")
                ...
            else:
                print('Fuel Identifier for site {site.site_name} does not exist')
            ... 
